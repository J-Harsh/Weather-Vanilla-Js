...
function fetchWeatherData()
{
    ...
    fetch(`https://api.weatherapi.com/v1/current.json?key=40e6a410d02e4d77b2c222716221705&q=${cityInput}&aqi=no`)
    ...
    .then(data =>
        {
            ...
            //get icon from json
            const iconId=data.current.condition.icon.substr("//cdn.weatherapi.con/weather/64x64/".length);
